...
namespace Expanze
{
    ...
    class GameplayScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            GuiComponent usersHud = new GuiComponent(ScreenManager.Game, ScreenManager.Game.GraphicsDevice.Viewport.Width, 0, GameState.gameFont, Settings.scale(660), Settings.scale(46), "hud-top");
