...
namespace Expanze
{
    public enum TextEnum
    {
        ...
        MENU_HOT_SEAT_NO_AI,
        MENU_HOT_SEAT_POINTS,
        MENU_HOT_SEAT_MAP_TYPE,
        MENU_HOT_SEAT_MAP_SIZE,
        MENU_HOT_SEAT_MAP_WEALTH,
        ...
        GAME_SETTINGS_MAP_SIZE_SMALL,
        GAME_SETTINGS_MAP_SIZE_MEDIUM,
        GAME_SETTINGS_MAP_SIZE_BIG,
        GAME_SETTINGS_MAP_WEALTH_LOW,
        GAME_SETTINGS_MAP_WEALTH_MEDIUM,
        GAME_SETTINGS_MAP_WEALTH_HIGH,
        GAME_SETTINGS_MAP_TYPE_NORMAL,
        GAME_SETTINGS_MAP_TYPE_LOWLAND,
        GAME_SETTINGS_MAP_TYPE_WASTELAND,
