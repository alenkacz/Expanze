...
namespace Expanze
{
    public enum TextEnum
    {
        ...
        GAME_ALERT_TITLE_AI_BOUGHT_LICENCE,
        GAME_ALERT_DESTRIPTION_AI_BOUGHT_LICENCE1,
        GAME_ALERT_DESTRIPTION_AI_BOUGHT_LICENCE2,
        GAME_ALERT_AI_BOUGHT_LICENCE_CORN,
        GAME_ALERT_AI_BOUGHT_LICENCE_MEAT,
        GAME_ALERT_AI_BOUGHT_LICENCE_STONE,
        GAME_ALERT_AI_BOUGHT_LICENCE_WOOD,
        GAME_ALERT_AI_BOUGHT_LICENCE_ORE,
        GAME_ALERT_AI_BOUGHT_LICENCE_1,
        GAME_ALERT_AI_BOUGHT_LICENCE_2,
        GAME_ALERT_TITLE_AI_INVENTED_UPGRADE,
        GAME_ALERT_DESTRIPTION_AI_INVENTED_UPGRADE1,
        GAME_ALERT_DESTRIPTION_AI_INVENTED_UPGRADE2,
        GAME_ALERT_AI_INVENTED_UPGRADE_STEPHERD,
        GAME_ALERT_AI_INVENTED_UPGRADE_MILL,
        GAME_ALERT_AI_INVENTED_UPGRADE_QUARRY,
        GAME_ALERT_AI_INVENTED_UPGRADE_SAWMILL,
        GAME_ALERT_AI_INVENTED_UPGRADE_MINE,
        GAME_ALERT_AI_INVENTED_UPGRADE_1,
        GAME_ALERT_AI_INVENTED_UPGRADE_2,
